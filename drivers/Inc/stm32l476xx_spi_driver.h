...
typedef struct
{
	...
	uint8_t 	  *pTxBuffer; /*Almacena dirección del Tx buffer*/
	uint8_t 	  *pRxBuffer; /*Almacena dirección del Rx buffer*/
	uint8_t 	  TxLen; /*Va a almacenar la longitud de TX*/
	uint8_t 	  RxLen; /*Va a almacenar la longitud de RX*/
	uint8_t 	  TxState; /*Va a almacenar el estatus del buffer*/
	uint8_t 	  RxState; /*Va a almacenar el estatus del buffer*/
}SPI_Handle_t;
